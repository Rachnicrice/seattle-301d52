...
function displayPics(){
  ...
  // The previous line of code threw an error because const is only scoped to it's block od code whereas the console.log exsisted outside of that block. The code works now because we moved the console.log into the code block where the const variable exists.
